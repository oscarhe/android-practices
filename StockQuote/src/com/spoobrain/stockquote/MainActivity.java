package com.spoobrain.stockquote;
...
public class MainActivity extends Activity {
	...
	public final static String STOCK_SYMBOL = "com.spoobrain.stockquote.STOCK";
	...
	Button enterStockSymbolButton, deleteStocksButton;
	...
	private void insertStockInScrollView(String stock, int arrayIndex) {
		...
		// Used to set stock_quote_row in the scroll view dynamically
	...
	public OnClickListener enterStockButtonListener = new Button.OnClickListener() {
	...
	public OnClickListener deleteStocksButtonListener = new Button.OnClickListener() {
	...
	public OnClickListener getStockActivityListener = new Button.OnClickListener() {
	...
	public OnClickListener getStockFromWebsiteListener = new Button.OnClickListener() {
